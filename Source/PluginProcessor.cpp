...
void SimpleEQAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    ...
    //osc.setFrequency(JUCE_LIVE_CONSTANT(15000));
    //juce::dsp::AudioBlock<float> block(buffer);
    //buffer.clear(); //clear any audio coming in
...
ChainSettings getChainSettings(juce::AudioProcessorValueTreeState& apvts)
{
    ...
    // This works but will give a normalized value
    //apvts.getParameter("LowCut Freq") -> getValue():

    //load is used becuase getRawParameterValue is an atomic, and load returns the value of atomic wo performing modifications
...
void SimpleEQAudioProcessor::updatePeakFilter(const ChainSettings& chainSettings)
{
    ...
    // Make an enum to define each link's position in the chain
...
void SimpleEQAudioProcessor::updateHighCutFilters(const ChainSettings& chainSettings)
{
    ...
    leftChain.setBypassed<ChainPositions::HiCut>(chainSettings.highCutBypassed);
    rightChain.setBypassed<ChainPositions::HiCut>(chainSettings.highCutBypassed);
...
void SimpleEQAudioProcessor::updateFilters() 
{
    ...
    updateHighCutFilters(chainSettigns);
...
juce::AudioProcessorValueTreeState::ParameterLayout SimpleEQAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("LowCut Freq", "LowCut Freq", juce::NormalisableRange<float>(20.f, 20000.f, 1.f,.5f), 20.f));
    layout.add(std::make_unique<juce::AudioParameterFloat>("Hicut Freq", "HiCut Freq", juce::NormalisableRange<float>(20.f, 20000.f, 1.f, .5f), 20000.f));
